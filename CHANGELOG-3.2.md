...
- [#7807](https://github.com/hyperf/hyperf/pull/7807) Optimized AMQP consumer to log an error and automatically expand `concurrent.limit` when it is less than `qos.prefetch_count`, to avoid `AMQPInvalidFrameException`.
